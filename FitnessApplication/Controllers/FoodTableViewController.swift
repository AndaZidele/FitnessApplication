...
class FoodTableViewController: UITableViewController {
  ...
  /*  override func numberOfSections(in tableView: UITableView) -> Int {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "secondForFoodCell", for: indexPath) as? FoodTableViewCell else {return UITableViewCell()}

        // Configure the cell...
//        let activityFileS = activityFilesS[indexPath.row]
//        cell.foodImg?.image = UIImage(named: activityFileS.imageS)
//        cell.foodName?.text = activityFileS.nameS
